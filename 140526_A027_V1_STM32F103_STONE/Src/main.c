...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, CHAIR_DOWN_Pin|B_Pin|Reserve_out_1_Pin|Status_LED_Pin
                          |Error_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, CHAIR_UP_Pin|BACKREST_UP_Pin|BACKREST_DOWN_Pin|SPITTOON_Pin
                          |A_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LIGHT_ON_Pin|WATER_S_Pin|WATER_F_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : CHAIR_DOWN_Pin B_Pin Reserve_out_1_Pin Status_LED_Pin
                           Error_LED_Pin */
  GPIO_InitStruct.Pin = CHAIR_DOWN_Pin|B_Pin|Reserve_out_1_Pin|Status_LED_Pin
                          |Error_LED_Pin|GPIO_PIN_5;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : CHAIR_UP_Pin BACKREST_UP_Pin BACKREST_DOWN_Pin SPITTOON_Pin
                           A_Pin */
  GPIO_InitStruct.Pin = CHAIR_UP_Pin|BACKREST_UP_Pin|BACKREST_DOWN_Pin|SPITTOON_Pin
                          |A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : LIGHT_ON_Pin WATER_S_Pin WATER_F_Pin */
  GPIO_InitStruct.Pin = LIGHT_ON_Pin|WATER_S_Pin|WATER_F_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : SPRAY_Pin CHIP_Pin Pedal_ON_OFF_Pin */
  GPIO_InitStruct.Pin = SPRAY_Pin|CHIP_Pin|Pedal_ON_OFF_Pin;
